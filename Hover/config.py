...
class Config(object):
    ...
    def __init__(self):
        ...
        act_shape = [128, 128] # patch shape used as input to network - central crop performed after augmentation
        out_shape = [36, 36] # patch shape at output of network
        ...
        if model_mode == "fast":
            if act_shape != [128,128] or out_shape != [36,36]:
        ...
        self.log_dir = "/data/jhan/PanNuke/" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "/data/jhan/PanNuke/merged/fold1",
            "/data/jhan/PanNuke/merged/fold2"
        ]
        self.valid_dir_list = [
            "/data/jhan/PanNuke/merged/fold3"
        ]
